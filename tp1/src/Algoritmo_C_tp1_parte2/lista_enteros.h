...
class Lista_enteros {
    ...
    public:
        ...
        /* Pre y pos: igual a obtener_buscado.
         *            Hace la busqueda en base a inicio de contador en 0.
         */
        int obtener_buscado_v2 (int posicion);
         ...
         *      posicion es un int válido.
         *      posicion no es mayor a tamanio.
         *      nuevo_valor es un int válido.
         * Post: Carga el elemento en posicion de Lista_enteros con nuevo_valor.
         */
        void modificar_buscado (int posicion, int nuevo_valor);
